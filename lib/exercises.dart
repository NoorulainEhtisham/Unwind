...
class Exercises extends ChangeNotifier {
  List<Exercise> exercises = [
    ...
    Exercise(
        ...
        script: 'scripts/BodyScanForSleep_Transcript-15-UCLA.pdf',
    ...
    Exercise(
        ...
        script: 'scripts/CompleteMeditation_Transcript.pdf',
    ...
    Exercise(
        ...
        script: 'scripts/BreathSoundBody_Transcript.pdf',
    ...
    Exercise(
        ...
        script: 'scripts/Vipassana-Mindfulness-Meditation-RA-CD-TaraBrach.pdf',
    ...
    Exercise(
        ...
        script: 'scripts/Walking-Meditation-Instructions.pdf',
